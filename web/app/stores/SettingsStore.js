...
const CORE_ASSET = "AGS"; // Setting this to AGS to prevent loading issues when used with AGS chain which is the most usual case currently
        ...
        return new Promise((resolve) => {
            ...
            let topMarkets = {
                markets_4018d784: [ // BTS MAIN NET
                    ...
                    "OPEN.INCNT", "KAPITAL", "OPEN.MAID", "OPEN.SBD", "OPEN.GRC", "YOYOW", "EOS"
                ],
